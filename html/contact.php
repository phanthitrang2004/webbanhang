...
<head>
    ...
    <title>Liên hệ -Phan Thị Trang </title>
</head>
            ...
            <div class="wrapper-contact">
                <section class="section">
                    ...
                    <div class="map">
                        ...
                        <p>Địa chỉ: Trong phố ẩm thực , Thành phố Việt Trì, Tỉnh Phú Thọ</p>
                        <strong>Hotline: 0372237956</strong>
                        <br>
                        <strong>Email: Boutique@gmail.com</strong>
                    </div>
                </section>
            </div>
        </div>
        ...
        <footer>
            ...
            <div class="footer2">
                <div class="footer2-content">
                    <p><i class="fa-solid fa-house-chimney"></i>Phan Thị Trang</p>
